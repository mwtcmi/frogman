...
**Headless PBX control through MCP and HTTP API.** Any AI, bot, or app connects and manages FreePBX through 247 tools. No GraphQL needed.
...
Frogman is the MCP server — the AI interface to the PBX. Frogman is the FreePBX module that provides the 247 tools it exposes. Together, they have two interfaces:

- **MCP Server** — the core product. Any AI connects via MCP and uses 247 tools to control, diagnose, and troubleshoot the PBX. This is where RAG, reasoning, and intelligent support happen.
